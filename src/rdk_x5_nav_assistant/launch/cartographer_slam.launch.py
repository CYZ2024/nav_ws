#!/usr/bin/env python3
"""Cartographer 2D SLAM launch for shopping cart — mapping mode.

No odometry, pure LiDAR (YDLIDAR X3 via vp100_ros2).
Publishes: /scan, TF (map -> base_footprint -> base_link -> laser_link), /map
"""
...
def generate_launch_description() -> LaunchDescription:
    ...
    config_basename = LaunchConfiguration("configuration_basename", default="cartographer_2d.lua")
